...
enum EMaterialValueType
{
	...
	MCT_Texture2DArray = 2048, // FB Bulgakov - Texture2D Array
	MCT_Texture		= 16|32|64|1024|2048,
};
...
public:
	...
	uint32 GetAllocatedSize() const
	{
		return UniformVectorExpressions.GetAllocatedSize()
			...
			+ Uniform2DTextureArrayExpressions.GetAllocatedSize() // FB Bulgakov - Texture2D Array
...
protected:
	...
	TArray<TRefCountPtr<FMaterialUniformExpressionTexture> > Uniform2DTextureArrayExpressions; // FB Bulgakov - Texture2D Array
...
public:
	...
	*/
	...
	ENGINE_API const TArray<TRefCountPtr<FMaterialUniformExpressionTexture> >& GetUniform2DTextureArrayExpressions() const; // FB Bulgakov - Texture2D Array
