...
void UMaterialInstance::GetTextureExpressionValues(const FMaterialResource* MaterialResource, TArray<UTexture*>& OutTextures, TArray< TArray<int32> >* OutIndices) const
{
	...
	ExpressionsByType[1] = &MaterialResource->GetUniform2DTextureArrayExpressions();
	ExpressionsByType[2] = &MaterialResource->GetUniformCubeTextureExpressions();
...
void UMaterialInstance::OverrideTexture(const UTexture* InTextureToOverride, UTexture* OverrideTexture, ERHIFeatureLevel::Type InFeatureLevel)
{
	...
	if (bHasStaticPermutationResource)
	{
		...
		ExpressionsByType[1] = &SourceMaterialResource->GetUniform2DTextureArrayExpressions();
		ExpressionsByType[2] = &SourceMaterialResource->GetUniformCubeTextureExpressions();
