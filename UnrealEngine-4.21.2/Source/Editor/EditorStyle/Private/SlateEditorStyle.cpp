...
void FSlateEditorStyle::FStyle::SetupLevelEditorStyle()
...
#if WITH_EDITOR
	{
		...
		Set("LevelEditor.MeshPaintMode.AdvancedMeshPaint", new IMAGE_BRUSH("Icons/AdvancedMeshPaint_40x", Icon40x40));
		Set("LevelEditor.MeshPaintMode.AdvancedMeshPaint.Small", new IMAGE_BRUSH("Icons/AdvancedMeshPaint_40x", Icon20x20));
		// FB Bulgakov End
