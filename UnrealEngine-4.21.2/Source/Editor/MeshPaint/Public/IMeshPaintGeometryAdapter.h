...
public:
	...
	virtual TArray<uint32> SphereIntersectTriangles(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings) const = 0;

	/** Retrieves the influenced vertex indices which intersect the given sphere */
	virtual void GetInfluencedVertexIndices(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings, TSet<int32> &InfluencedVertices) const = 0;
	
	/** Retrieves the influenced vertex indices and positions that intersect the given sphere */
	virtual void GetInfluencedVertexData(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings, TArray<TPair<int32, FVector>>& OutData) const = 0;

	/** Returns the vertex positions which intersect the given sphere */
	virtual TArray<FVector> SphereIntersectVertices(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings) const = 0;
