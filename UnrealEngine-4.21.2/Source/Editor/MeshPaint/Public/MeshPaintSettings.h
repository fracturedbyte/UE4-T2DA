...
public:
	...
	// FB Bulgakov - Texture2D Array
	/** Amount of falloff to apply (0.0 - 1.0) */
	UPROPERTY(EditAnywhere, Category = Brush, meta = (DisplayName = "Normal Deviation", UIMin = "-1.0", UIMax = "1.0", ClampMin = "-1.0", ClampMax = "1.0"))
	float BrushNormalDeviation;
	...
	/** Whether paint only selected triangle */
	UPROPERTY(EditAnywhere, Category = Brush, meta = (DisplayName = "Only selected triangle"))
	bool bOnlySelectedTriangle;

	/** Whether use normal deviation */
	UPROPERTY(EditAnywhere, Category = Brush, meta = (DisplayName = "Use normal deviation"))
	bool bUseNormalDeviation;
	// FB Bulgakov End
