...
#include "AssetTypeActions/AssetTypeActions_Texture2DArray.h" // FB Bulgakov - Texture2D Array
	...
	, NextUserCategoryBit(EAssetTypeCategories::FirstUser)
{
	...
	RegisterAssetTypeActions(MakeShareable(new FAssetTypeActions_Texture2DArray)); // FB Bulgakov - Texture2D Array
