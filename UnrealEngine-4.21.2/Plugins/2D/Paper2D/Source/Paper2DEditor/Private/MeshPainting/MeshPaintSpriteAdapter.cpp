...
TArray<uint32> FMeshPaintSpriteAdapter::SphereIntersectTriangles(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings) const // FB Bulgakov Begin - Texture2D Array
{
...
void FMeshPaintSpriteAdapter::GetInfluencedVertexIndices(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings, TSet<int32> &InfluencedVertices) const // FB Bulgakov - Texture2D Array
{
...
TArray<FVector> FMeshPaintSpriteAdapter::SphereIntersectVertices(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings) const // FB Bulgakov - Texture2D Array
{
...
void FMeshPaintSpriteAdapter::GetInfluencedVertexData(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings, TArray<TPair<int32, FVector>>& OutData) const // FB Bulgakov - Texture2D Array
{
	// Get a list of (optionally front-facing) triangles that are within a reasonable distance to the brush
	TArray<uint32> InfluencedTriangles = SphereIntersectTriangles(
		ComponentSpaceSquaredBrushRadius,
