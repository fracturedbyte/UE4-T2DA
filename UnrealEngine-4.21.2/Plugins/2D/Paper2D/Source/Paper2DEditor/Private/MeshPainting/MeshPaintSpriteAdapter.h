...
public:
	...
	virtual TArray<uint32> SphereIntersectTriangles(const float ComponentSpaceSquaredBrushRadius, const FVector& ComponentSpaceBrushPosition, const FVector& ComponentSpaceBrushNormal, const FVector& ComponentSpaceCameraPosition, const class UPaintBrushSettings* BrushSettings) const override; // FB Bulgakov - Texture2D Array
